...
#site info: Galdam
gal <- read.csv("https://docs.google.com/spreadsheets/d/e/2PACX-1vQQ9zhSCHjt-1qdSLltD1rhEI_DmaIKtah5yA9WWlsB0gGJWMOYltZR71r00NgkfaYz8YH392oZOWPu/pub?gid=0&single=true&output=csv")
...
gal_retouch <- 
  gal %>% 
  # if name is "scraper" or "end_scraper" or " side scraper" or "notch", call it 'Y'
  mutate(retouch_true = ifelse(as.character(name) = "end_scraper"|"side_scraper"|"notch" , yes, no))
